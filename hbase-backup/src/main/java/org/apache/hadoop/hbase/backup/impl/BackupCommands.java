  ...
  public static class CreateCommand extends Command {
    ...
    public void execute() throws IOException {
      ...
      if (!continuousBackup && tableNameList != null) {
        ...
        try (BackupSystemTable table = new BackupSystemTable(conn)) {
          continuousBackupTableSet = table.getContinuousBackupTableSet();
          ...
          noneTablesContinuousBackupEnabled =
        ...
        if (!allTablesContinuousBackupEnabled && !noneTablesContinuousBackupEnabled) {
          System.out
            .println("ERROR: Some tables already have backups taken as part of Continuous Backup, "
